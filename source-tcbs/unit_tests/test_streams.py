...
import pytest
from source_tcbs.source import TcbsStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(TcbsStream, "path", "v0/example_endpoint")
    mocker.patch.object(TcbsStream, "primary_key", "test_primary_key")
    mocker.patch.object(TcbsStream, "__abstractmethods__", set())
