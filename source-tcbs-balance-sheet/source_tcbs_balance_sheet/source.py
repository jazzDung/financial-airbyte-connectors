...
class BalanceSheet(OrganizationSubStream):

    primary_key = ["ticker", "quarter", "year"]
    
    def path(self, stream_state: Mapping[str, Any] = None, stream_slice: Mapping[str, Any] = None, next_page_token: Mapping[str, Any] = None) -> str:
        return f'https://apipubaws.tcbs.com.vn/tcanalysis/v1/finance/{stream_slice["ticker"]}/balancesheet?yearly=0&isAll={self.all_data}'
    ...
    def parse_response(self, response: requests.Response, stream_slice: Mapping[str, Any] = None, **kwargs) -> Iterable[Mapping]:
        ...
        url = f'https://apipubaws.tcbs.com.vn/tcanalysis/v1/finance/{stream_slice["ticker"]}/balancesheet'
...
class SourceTcbsBalanceSheet(AbstractSource):
    def check_connection(self, logger, config) -> Tuple[bool, any]:
        ...
        if config["frequency"] not in ["Yearly", "Quarterly", "Both"]:
            ...
            try:
                url = f'https://apipubaws.tcbs.com.vn/tcanalysis/v1/finance/TCB/balancesheet'
