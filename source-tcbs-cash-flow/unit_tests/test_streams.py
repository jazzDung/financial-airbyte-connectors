...
import pytest
from source_tcbs_cash_flow.source import Organization


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(Organization, "path", "v0/example_endpoint")
    mocker.patch.object(Organization, "primary_key", "test_primary_key")
    mocker.patch.object(Organization, "__abstractmethods__", set())
